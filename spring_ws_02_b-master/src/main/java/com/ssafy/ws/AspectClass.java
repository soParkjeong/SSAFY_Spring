...
public class AspectClass {
	...
	@Around("execution(* com.ssafy.ws.TargetClass.*(..))")
	...
	@Pointcut("execution(* com.ssafy.ws.*.*(..))")
	...
	@AfterReturning(value = "execution(String com.ssafy..*.*(..))", returning = "result")
	...
	// 실행한다.
	@AfterThrowing(value = "execution(* com.ssafy..*.*(..) throws java.lang.RuntimeException)", throwing = "ex")
