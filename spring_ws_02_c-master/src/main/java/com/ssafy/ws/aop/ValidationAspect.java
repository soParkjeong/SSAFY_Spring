...
public class ValidationAspect {
	...
	*/
	...
	public void aroundEnter(ProceedingJoinPoint joinPoint) throws Throwable {
	...
	public void aroundLeave(ProceedingJoinPoint joinPoint) throws Throwable {
		Student student = (Student) joinPoint.getTarget();
		if (student.getState().equals("퇴실")) {
			throw new IllegalStateException("이미 퇴실을 진행한 학생입니다.");
		} else {
			joinPoint.proceed(); // 원래 leave() 메소드 호출
		}
	}
